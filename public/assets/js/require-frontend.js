require.config({
    ...
    paths: {
        ...
        'hayao-index': '../libs/hayao/js/index',
        'hayao-HZRecorder': '../libs/hayao/js/HZRecorder',
        'hayao-answer': '../libs/hayao/js/answer',
        'hayao-jquery1.11.1': '../libs/hayao/js/jquery-1.11.1.min',
        'hayao-photoswipe': '../libs/hayao/js/photoswipe',
        'hayao-photoswipe-ui': '../libs/hayao/js/photoswipe-ui-default.min',
    },
    // shim依赖配置
    shim: {
        'addons': ['frontend'],
