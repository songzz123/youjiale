...
use app\yjl\model\TestYjlAbapAiLog;
use app\yjl\model\TestYjlAnswers;
use app\yjl\model\TestYjlClickSym;
use app\yjl\model\TestYjlKupperMan;
use app\yjl\model\TestYjlSymptom;
use think\Request;

class Testyjl extends Frontend
{
    ...
    public function index()
    {
        ...
        if (!empty($_REQUEST['ref'])) {
            ...
            $ids = TestYjlSymptom::where($where)
                ->field('id')
                ->find();
...
//    }
            ...
            switch ($act) {
                ...
                case 'gailv':
                    ...
                    if ($sel_ress) {
                        ...
                        if (TestYjlAnswers::update($qai2, $where)) {
    ...
    function getInfobyapi($url, $data)
    {
        $header = array(
            ...
            'Authorization:AICP 48473806-d5b8-49b9-b97f-92471c32df54');
        $ch = curl_init();
